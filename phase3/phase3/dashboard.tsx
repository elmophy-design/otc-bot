...
import { generateMarketSignal, getMarketScanner, getMarketStatus, ScannerRow, MarketSignal } from "../frontend_api";
            ...
            {signal && (
              <div style={{ marginTop: 14, padding: 14, border: "1px solid #202733", borderRadius: 12, background: "rgba(255,255,255,.02)" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10, marginBottom: 10 }}>
                  <div>
                    <div style={{ fontSize: 11, color: "#687386", textTransform: "uppercase", letterSpacing: ".08em" }}>Production Signal Engine</div>
                ...
                <div style={{ fontSize: 12, color: "#aab3c2", lineHeight: 1.6 }}>{signal.signal.reason || "No qualifying setup."}</div>
